...
namespace TalkingCart.Patches
{
    class ConfigManager
    {
        ...
        public static ConfigEntry<bool> enableUIInstructions;
        ...
        public static void Initialize(ConfigFile cfg)
        {
            ...
            enableUIInstructions = cfg.Bind<bool>("Behaviour", "EnableUIInstructions", true, "When this is turned off, the UI text telling you about keybinds when you hold the cart will not show up.");
        }
    }
}
